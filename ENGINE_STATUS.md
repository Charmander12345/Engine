...
- ✅ `Engine-Editor-API-Layer (Phase 12.1)`:
...
## Letzte Änderung (Asset-Cooking-Pipeline – Phase 10.2) ⏸️ ENTFERNT

- ⏸️ `Asset-Cooking-Pipeline (Phase 10.2)`: ~~Integrierte Asset-Verarbeitung beim Build-Prozess.~~ **ENTFERNT** – cookAssetsForBuild, generateAssetManifest, CookStats entfernt. Wird nach Editor-Separation-Rework neu implementiert.
